...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://secure-house-next-js.vercel.app/garage-doors/sectional-garage-doors',
  },
};

export default function Page() {
  const filePath = path.join(process.cwd(), 'app', 'garage-doors/sectional-garage-doors', 'content.html');
