...
import HeroButtons from "@/components/doors/industrial-style-doors/HeroButtons";
import Breadcrumb from "@/components/doors/industrial-style-doors/Breadcrumb";
import Intro from "@/components/doors/industrial-style-doors/Intro";
import ImageBand from "@/components/doors/industrial-style-doors/ImageBand";
import Design from "@/components/doors/industrial-style-doors/Design";
import MainFeatures from "@/components/doors/industrial-style-doors/MainFeatures";
import CrittallHeritage from "@/components/doors/industrial-style-doors/CrittallHeritage";
import IndustrialRuggedness from "@/components/doors/industrial-style-doors/IndustrialRuggedness";
import FireRating from "@/components/doors/industrial-style-doors/FireRating";
import Comparison from "@/components/doors/industrial-style-doors/Comparison";
import Gallery from "@/components/doors/industrial-style-doors/Gallery";
import FrequentlyAskedQuestionsFaq from "@/components/doors/industrial-style-doors/FrequentlyAskedQuestionsFaq";
import { DEFAULT_OG_IMAGE } from "../../../lib/seo";

// Copy is the client's real content (doc + Wayback snapshot of the old
// WordPress page). Layout mirrors /door-styles/victorian-doors section for
// section, per the client's request that the two pages look the same.
// Photos are stand-ins picked from the site's own steel/glazing library -
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  className="page type-page status-publish hentry"
                >
                  <div
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/01/Group-203-1.webp") !important' } as unknown as React.CSSProperties}
                          >
                            <div
