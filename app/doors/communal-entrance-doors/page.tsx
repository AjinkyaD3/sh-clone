...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://secure-house-next-js.vercel.app/doors/communal-entrance-doors',
  },
};

export default function Page() {
  const filePath = path.join(process.cwd(), 'app', 'doors/communal-entrance-doors', 'content.html');
