                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-5 fusion_builder_column_1_1 1_1 fusion-flex-column fusion-flex-align-self-stretch"
                          style={{ '--awb-padding-top': '390px', '--awb-padding-right': '150px', '--awb-padding-bottom': '57px', '--awb-padding-left': '150px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-bg-image': 'linear-gradient( 180deg, rgba(33, 35, 38, 0.41) 0%, rgba(33, 35, 38, 0.2) 100% )', '--awb-bg-image-small': 'linear-gradient( 180deg, rgba(33, 35, 38, 0.41) 0%, rgba(33, 35, 38, 0.2) 100% )', '--awb-bg-size': 'cover', '--awb-width-large': '100%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                            ...
                            data-bg-gradient="linear-gradient(180deg, rgba(33,35,38,0.41) 0%,rgba(33,35,38,0.2) 100%)"
                            data-bg-small="/legacy-assets/uploads/2025/01/modern-farmhouse-black-interior-door-1-2.png"
                            data-bg-url="/legacy-assets/uploads/2025/01/Group-202-1.png"
                            data-fusion-responsive-bg="1"
                            style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/01/Group-202-1.png") !important' } as unknown as React.CSSProperties}
                          >
                            <div
                              className="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-one"
                            >
                              <h1
                                className="fusion-title-heading title-heading-left fusion-responsive-typography-calculated"
                                style={{ fontFamily: 'var(--awb-typography1-font-family)', fontWeight: 'var(--awb-typography1-font-weight)', fontStyle: 'var(--awb-typography1-font-style)', margin: '0', textTransform: 'none', '--fontSize': '50', lineHeight: '1.2' } as unknown as React.CSSProperties}
                              >
                                {` Doors `}
                              </h1>
                            </div>
                    ...
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '106px', '--awb-padding-right': '80px', '--awb-padding-bottom': '0px', '--awb-padding-left': '80px', '--awb-padding-top-small': '90px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-margin-top': '0px', '--awb-margin-bottom': '80px', '--awb-margin-bottom-small': '0px', '--awb-background-image': 'linear-gradient( 180deg, #f5efe9 70%, var(--awb-color1) 70% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-6 fusion_builder_column_3_5 3_5 fusion-flex-column fusion-flex-align-self-center"
                          data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                          style={{ '--awb-padding-right': '20px', '--awb-padding-bottom': '64px', '--awb-padding-left': '20px', '--awb-padding-right-small': '0px', '--awb-padding-left-small': '0px', '--awb-bg-size': 'cover', '--awb-width-large': '60%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '57px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                            className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-center fusion-content-layout-block"
                          >
                            <div
                            ...
                            >
                              <p>
                                {` Our products are custom made – beautiful and functional. We can produce doors to suit every type of property, location and budget. `}
                              </p>
                            </div>
                          </div>
                        </div>
                        <div
                          ...
                          data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                          style={{ '--awb-padding-right': '70px', '--awb-padding-bottom': '64px', '--awb-padding-left': '70px', '--awb-padding-right-medium': '0px', '--awb-padding-left-medium': '0px', '--awb-padding-right-small': '0px', '--awb-padding-left-small': '0px', '--awb-bg-size': 'cover', '--awb-width-large': '100%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                          ...
                          >
                            <div
                              className="fusion-title title fusion-title-3 fusion-sep-none fusion-title-text fusion-title-size-two"
                              style={{ '--awb-text-color': 'var(--awb-color6)', '--awb-margin-bottom': '40px', '--awb-margin-bottom-small': '60px', '--awb-font-size': '33px' } as unknown as React.CSSProperties}
                            >
                              <h2
                                className="fusion-title-heading title-heading-left fusion-responsive-typography-calculated"
                                style={{ margin: '0', letterSpacing: '0px', textTransform: 'none', fontSize: '1em', '--fontSize': '33', lineHeight: '1.2' } as unknown as React.CSSProperties}
                              >
                                {` Residential doors `}
                              </h2>
                            </div>
                            <div
                              className="fusion-builder-row fusion-builder-row-inner fusion-row fusion-flex-align-items-center fusion-flex-justify-content-center fusion-flex-content-wrap"
                              style={{ width: '104% !important', maxWidth: '104% !important', marginLeft: 'calc(-4% / 2)', marginRight: 'calc(-4% / 2)' } as unknown as React.CSSProperties}
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-3 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <Link
                                    ...
                                    href="/doors/high-security-doors/"
                                  >
                                    <span
                                      ...
                                      style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-227x300.png") !important' } as unknown as React.CSSProperties}
                                    ></span>
                                  </Link>
                                </span>
                                <div
                                  ...
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-227x300.png"
                                >
                                  <div
                                    className="fusion-title title fusion-title-4 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-four"
                                    style={{ '--awb-text-color': 'var(--awb-color6)', '--awb-margin-bottom': '20px', '--awb-margin-bottom-small': '20px', '--awb-font-size': '20px' } as unknown as React.CSSProperties}
                                  >
                                    <h4
                                      className="fusion-title-heading title-heading-center fusion-responsive-typography-calculated"
                                      style={{ fontFamily: '"Montserrat"', fontStyle: 'normal', fontWeight: '500', margin: '0', textTransform: 'none', fontSize: '1em', '--fontSize': '20', '--minFontSize': '20', lineHeight: '1.2' } as unknown as React.CSSProperties}
                                    >
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-4 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <span
                                    className="fusion-column-inner-bg-image lazyload"
                                    data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                    style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-1-227x300.png") !important' } as unknown as React.CSSProperties}
                                  ></span>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-1-227x300.png"
                                >
                                  <div
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-5 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <span
                                    className="fusion-column-inner-bg-image lazyload"
                                    data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                    style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-4-227x300.png") !important' } as unknown as React.CSSProperties}
                                  ></span>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-4-227x300.png"
                                >
                                  <div
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-6 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <span
                                    className="fusion-column-inner-bg-image lazyload"
                                    data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                    style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-10-227x300.png") !important' } as unknown as React.CSSProperties}
                                  ></span>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-10-227x300.png"
                                >
                                  <div
                    ...
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '80px', '--awb-padding-bottom': '185px', '--awb-padding-left': '80px', '--awb-padding-right-small': '40px', '--awb-padding-bottom-small': '80px', '--awb-padding-left-small': '40px', '--awb-margin-top': '0px', '--awb-margin-bottom': '0px', '--awb-margin-bottom-small': '0px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 35%, var(--awb-color3) 35% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                        className="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
                        style={{ width: '104% !important', maxWidth: '104% !important', marginLeft: 'calc(-4% / 2)', marginRight: 'calc(-4% / 2)' } as unknown as React.CSSProperties}
                      >
                        <div
                          ...
                          data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                          style={{ '--awb-padding-right': '70px', '--awb-padding-bottom': '64px', '--awb-padding-left': '70px', '--awb-padding-right-small': '0px', '--awb-padding-left-small': '0px', '--awb-bg-size': 'cover', '--awb-width-large': '100%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                            className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column"
                          >
                            ...
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-7 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <span
                                    className="fusion-column-inner-bg-image lazyload"
                                    data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                    style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-11-227x300.png") !important' } as unknown as React.CSSProperties}
                                  ></span>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-11-227x300.png"
                                >
                                  <div
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-8 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <Link
                                    className="fusion-column-anchor"
                                    href="/doors/bullet-proof-doors/"
                                  >
                                    <span
                                      className="fusion-column-inner-bg-image lazyload"
                                      data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                      style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-13-227x300.png") !important' } as unknown as React.CSSProperties}
                                    ></span>
                                  </Link>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-13-227x300.png"
                                >
                                  <div
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-9 fusion_builder_column_inner_1_4 1_4 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '25%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <span
                                    className="fusion-column-inner-bg-image lazyload"
                                    data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                                    style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/03/Mask-group-14-227x300.png") !important' } as unknown as React.CSSProperties}
                                  ></span>
                                </span>
                                <div
                                  className="fusion-column-wrapper fusion-flex-justify-content-flex-end fusion-content-layout-block fusion-column-has-bg-image"
                                  data-bg-url="/legacy-assets/uploads/2025/03/Mask-group-14-227x300.png"
                                >
                                  <div
                    ...
                    >
                      ...
                      >
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-9 fusion_builder_column_1_2 1_2 fusion-flex-column fusion-flex-align-self-stretch"
                        ...
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-10 fusion_builder_column_1_2 1_2 fusion-flex-column fusion-flex-align-self-stretch"
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              style={{ '--awb-text-color': 'var(--awb-color6)', '--awb-font-size': '14px' } as unknown as React.CSSProperties}
                            >
                              <p
                                className="fusion-title-heading title-heading-center title-heading-tag fusion-responsive-typography-calculated"
                                style={{ margin: '0', textTransform: 'none', fontSize: '1em', '--fontSize': '14', '--minFontSize': '14', lineHeight: '1.3' } as unknown as React.CSSProperties}
                              >
