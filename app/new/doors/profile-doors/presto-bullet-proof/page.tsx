                ...
                >
                  ...
                  >
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '40px', '--awb-padding-right': '80px', '--awb-padding-left': '80px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-background-color': 'var(--awb-color3)', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                        ...
                        >
                          ...
                          >
                            <nav
                              ...
                              style={{ '--awb-font-size': '14px', '--awb-breadcrumb-sep': '"-"' } as unknown as React.CSSProperties}
                            >
                              <span>
                                <span>
                                  <Link
                    ...
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '140px', '--awb-padding-right': '120px', '--awb-padding-bottom': '141px', '--awb-padding-left': '120px', '--awb-padding-top-small': '60px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-margin-top': '0px', '--awb-margin-bottom': '136px', '--awb-margin-top-small': '0px', '--awb-margin-bottom-small': '75px', '--awb-background-color': 'var(--awb-color3)', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                        className="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
                        style={{ width: '104% !important', maxWidth: '104% !important', marginLeft: 'calc(-4% / 2)', marginRight: 'calc(-4% / 2)' } as unknown as React.CSSProperties}
                      >
                        ...
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-6 fusion_builder_column_1_2 1_2 fusion-flex-column"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <p>
                                          {` This is the system for flush mounted single or double-leaf doors, windows and glazed closures without thermal break. Forster, Janisol presto stands for security and safety and meets maximum demands for technical functionality and extreme long-term exposure to stress. `}
                                        </p>
                                      </div>
                                    </div>
                                  </blockquote>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <p>
                                          {` The system is suitable for use wherever there are no special thermal insulation requirements. Forster, Janisol presto is available in stainless steel for elegant and ambitious solutions. `}
                                        </p>
                                      </div>
                                    </div>
                                  </blockquote>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <img
                                  alt=""
                                  className="lazyload img-responsive wp-image-5456 bv-tag-attr-replace"
                                  data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 1306px"
                                  data-orig-src="/legacy-assets/uploads/2025/01/Group-241.png"
                                  data-sizes="auto"
                                  data-srcset="/legacy-assets/uploads/2025/01/Group-241-200x105.png 200w, /legacy-assets/uploads/2025/01/Group-241-400x209.png 400w, /legacy-assets/uploads/2025/01/Group-241-600x314.png 600w, /legacy-assets/uploads/2025/01/Group-241-800x419.png 800w, /legacy-assets/uploads/2025/01/Group-241-1200x628.png 1200w, /legacy-assets/uploads/2025/01/Group-241.png 1306w"
                                  decoding="async"
                                  fetchPriority="high"
                                  height="684"
                                  src="/legacy-assets/uploads/2025/01/Group-241.png"
                                  srcSet="/legacy-assets/uploads/2025/01/Group-241-200x105.png 200w, /legacy-assets/uploads/2025/01/Group-241-400x209.png 400w, /legacy-assets/uploads/2025/01/Group-241-600x314.png 600w, /legacy-assets/uploads/2025/01/Group-241-800x419.png 800w, /legacy-assets/uploads/2025/01/Group-241-1200x628.png 1200w, /legacy-assets/uploads/2025/01/Group-241.png 1306w"
                                  width="1306"
                                />
                              </span>
                            </div>
                                ...
                                >
                                  ...
                                  >
                                    <img
                                      alt=""
                                      aria-label=""
                                      className="lazyload img-responsive wp-image-5463 bv-tag-attr-replace"
                                      data-orig-sizes="(min-width: 2200px) 100vw, (min-width: 704px) 475px, (min-width: 672px) 704px, (min-width: 640px) 672px,"
                                      data-orig-src="/legacy-assets/uploads/2025/01/image-1-3.png"
                                      data-sizes="auto"
                                      data-srcset="/legacy-assets/uploads/2025/01/image-1-3-200x91.png 200w, /legacy-assets/uploads/2025/01/image-1-3-400x183.png 400w, /legacy-assets/uploads/2025/01/image-1-3-600x274.png 600w, /legacy-assets/uploads/2025/01/image-1-3-800x365.png 800w, /legacy-assets/uploads/2025/01/image-1-3.png 1185w"
                                      decoding="async"
                                      height="541"
                                      src="/legacy-assets/uploads/2025/01/image-1-3.png"
                                      srcSet="/legacy-assets/uploads/2025/01/image-1-3-200x91.png 200w, /legacy-assets/uploads/2025/01/image-1-3-400x183.png 400w, /legacy-assets/uploads/2025/01/image-1-3-600x274.png 600w, /legacy-assets/uploads/2025/01/image-1-3-800x365.png 800w, /legacy-assets/uploads/2025/01/image-1-3.png 1185w"
                                      title=""
                                      width="1185"
                                    />
                                  </div>
