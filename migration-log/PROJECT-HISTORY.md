...
- Ran a content/structure/image/video audit of the homepage, /projects/, /about-us/, and all 27 mega-menu links (30 pages) against the live site: found and fixed unconverted lazy-load background images on 14 pages and ~780 missing WordPress responsive image thumbnail variants across the doors/windows/grilles-shutters/garage-doors sub-pages (three commits, not yet pushed). Confirmed the /blog/ index 404 is intentional (blocked on client content), not a regression
