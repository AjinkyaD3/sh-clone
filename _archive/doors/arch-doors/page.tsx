...
export const metadata: Metadata = {
  ...
  description: 'Custom-built arch doors, manufactured in the UK. Steel-reinforced arched front doors for period and modern properties. Security certified. Free consultation.',
  alternates: {
    canonical: 'https://secure-house-next-js.vercel.app/doors/arch-doors',
  },
};

export default function Page() {
  const filePath = path.join(process.cwd(), 'app', 'doors/arch-doors', 'content.html');
