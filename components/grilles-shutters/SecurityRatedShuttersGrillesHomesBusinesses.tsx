...
export default function Row4() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '56px', '--awb-padding-right': '180px', '--awb-padding-bottom': '0px', '--awb-padding-left': '180px', '--awb-padding-top-small': '28px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-margin-top-small': '0px', '--awb-margin-top': '0px', '--awb-margin-bottom': '0px', '--awb-margin-bottom-small': '0px', '--awb-background-image': 'linear-gradient( 180deg, #f5efe9 70%, var(--awb-color1) 70% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        <div
                          ...
                          style={{ '--awb-padding-right': '200px', '--awb-padding-bottom': '28px', '--awb-padding-left': '200px', '--awb-padding-right-small': '0px', '--awb-padding-bottom-small': '4px', '--awb-padding-left-small': '0px', '--awb-bg-size': 'cover', '--awb-width-large': '100%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '29px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '0px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <Link
                                    ...
                                    href="/grilles-shutters/security-shutters/"
                                  >
                                    <span
                              ...
                              >
                                ...
                                >
                                  <Link
                                    className="fusion-column-anchor"
                                    href="/grilles-shutters/high-security-shutters/"
                                  >
                                    <span
                                      className="fusion-column-inner-bg-image lazyload"
                                      data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
                              ...
                              >
                                ...
                                >
                                  <Link
                                    className="fusion-column-anchor"
                                    href="/grilles-shutters/colllabsible-grilles/"
                                  >
                                    <span
                                      className="fusion-column-inner-bg-image lazyload"
                                      data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
