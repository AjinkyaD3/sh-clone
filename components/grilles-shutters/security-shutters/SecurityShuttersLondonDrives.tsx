export default function Row15() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '0px', '--awb-padding-bottom': '63px', '--awb-padding-left': '0px', '--awb-padding-right-small': '0px', '--awb-padding-left-small': '0px', '--awb-margin-top': '194px', '--awb-margin-bottom': '0px', '--awb-margin-top-small': '108px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 12%, var(--awb-color1) 11% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        <div
                          ...
                          style={{ '--awb-bg-size': 'cover', '--awb-width-large': '100%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '1.92%', '--awb-margin-bottom-large': '81px', '--awb-spacing-left-large': '1.92%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '45px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div
                          ...
                          >
                            <div
                              ...
                              style={{ '--awb-text-color': '#1c1e36', '--awb-margin-bottom': '30px', '--awb-margin-bottom-small': '20px', '--awb-font-size': 'var(--awb-typography1-font-size)' } as unknown as React.CSSProperties}
                            >
                              <h3
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        alt=""
                                        className="lazyload img-responsive wp-image-6170 bv-tag-attr-replace"
                                        data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 791px"
                                        data-orig-src="/legacy-assets/uploads/2025/02/paveikslas-107.webp"
                                        data-sizes="auto"
                                        data-srcset="/legacy-assets/uploads/2025/02/paveikslas-107-200x169.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-107-400x337.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-107-600x506.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-107.webp 791w"
                                        decoding="async"
                                        height="667"
                                        src="/legacy-assets/uploads/2025/02/paveikslas-107.webp"
                                        srcSet="/legacy-assets/uploads/2025/02/paveikslas-107-200x169.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-107-400x337.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-107-600x506.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-107.webp 791w"
                                        width="791"
                                      />
                                    </span>
                                  </div>
