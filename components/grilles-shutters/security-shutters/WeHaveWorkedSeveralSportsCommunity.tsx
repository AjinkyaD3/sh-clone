                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-23 fusion_builder_column_inner_1_2 1_2 fusion-flex-column"
                                style={{ '--awb-padding-top': '236px', '--awb-padding-right': '71px', '--awb-padding-left': '148px', '--awb-padding-top-small': '71px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-bg-size': 'cover', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '3.84%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '2', '--awb-margin-top-small': '0px', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <div
                                  className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column"
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      {` We have worked with`}
                                      <br />
                                      {` several sports and community centres`}
                                      <br />
                                      {` across the UK `}
                                    </h3>
                                  </div>
                                  ...
                                  >
                                    <div
                                      ...
                                      id="accordion-2204-10"
                                    >
                                      <div
                                        className="fusion-panel panel-default panel-8e93a3ef106cc2708 fusion-toggle-no-divider"
                                      ...
                                      >
                                        ...
                                        >
                                          <h4
                                            ...
                                            id="toggle_8e93a3ef106cc2708"
                                          >
                                            <a
                                              aria-controls="8e93a3ef106cc2708"
                                              aria-expanded="false"
                                              data-parent="#accordion-2204-10"
                                              data-target="#8e93a3ef106cc2708"
                                              data-toggle="collapse"
                                              href="#8e93a3ef106cc2708"
                                              role="button"
                                            >
                                              <span
                                                aria-hidden="true"
                                        ...
                                        <div
                                          aria-labelledby="toggle_8e93a3ef106cc2708"
                                          className="panel-collapse collapse"
                                          id="8e93a3ef106cc2708"
                                        >
                                          <div
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        alt=""
                                        className="lazyload img-responsive wp-image-6188 bv-tag-attr-replace"
                                        data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 698px"
                                        data-orig-src="/legacy-assets/uploads/2025/02/image-8.webp"
                                        data-sizes="auto"
                                        data-srcset="/legacy-assets/uploads/2025/02/image-8-200x245.webp 200w, /legacy-assets/uploads/2025/02/image-8-400x489.webp 400w, /legacy-assets/uploads/2025/02/image-8-600x734.webp 600w, /legacy-assets/uploads/2025/02/image-8.webp 698w"
                                        decoding="async"
                                        height="854"
                                        src="/legacy-assets/uploads/2025/02/image-8.webp"
                                        srcSet="/legacy-assets/uploads/2025/02/image-8-200x245.webp 200w, /legacy-assets/uploads/2025/02/image-8-400x489.webp 400w, /legacy-assets/uploads/2025/02/image-8-600x734.webp 600w, /legacy-assets/uploads/2025/02/image-8.webp 698w"
                                        width="698"
                                      />
                                    </span>
                                  </div>
