export default function Row11() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '0px', '--awb-padding-bottom': '63px', '--awb-padding-left': '0px', '--awb-padding-bottom-small': '155px', '--awb-margin-bottom': '0px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 12%, #847b73 11% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      {` Safe. Secure. Protected. It’s time to add aluminium security shutters to your property. As well as fitting steel security doors and windows, adding aluminium security shutters and security grilles to your home or a roller garage door is the ideal way to protect it even further from intruders and burglars. `}
                                    </p>
                                  </div>
                                  <div
                                  ...
                                  >
                                    ...
                                    >
                                      <div
                                        className="fusion-panel panel-default panel-3dabc31d1a5207fbd fusion-toggle-no-divider"
                                      ...
                                      >
                                        ...
                                        >
                                          <h4
                                            ...
                                            id="toggle_3dabc31d1a5207fbd"
                                          >
                                            <a
                                              aria-controls="3dabc31d1a5207fbd"
                                              aria-expanded="false"
                                              data-parent="#accordion-2204-3"
                                              data-target="#3dabc31d1a5207fbd"
                                              data-toggle="collapse"
                                              href="#3dabc31d1a5207fbd"
                                              role="button"
                                            >
                                              <span
                                                aria-hidden="true"
                                        ...
                                        <div
                                          aria-labelledby="toggle_3dabc31d1a5207fbd"
                                          className="panel-collapse collapse"
                                          id="3dabc31d1a5207fbd"
                                        >
                                          <div
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        alt=""
                                        className="lazyload img-responsive wp-image-6158 bv-tag-attr-replace"
                                        data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 681px"
                                        data-orig-src="/legacy-assets/uploads/2025/02/paveikslas-105.webp"
                                        data-sizes="auto"
                                        data-srcset="/legacy-assets/uploads/2025/02/paveikslas-105-200x234.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-105-400x468.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-105-600x701.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-105.webp 681w"
                                        decoding="async"
                                        height="796"
                                        src="/legacy-assets/uploads/2025/02/paveikslas-105.webp"
                                        srcSet="/legacy-assets/uploads/2025/02/paveikslas-105-200x234.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-105-400x468.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-105-600x701.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-105.webp 681w"
                                        width="681"
                                      />
                                    </span>
                                  </div>
