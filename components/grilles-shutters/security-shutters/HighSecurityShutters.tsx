export default function Row20() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '0px', '--awb-padding-bottom': '63px', '--awb-padding-left': '0px', '--awb-padding-bottom-small': '121px', '--awb-margin-bottom': '0px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 12%, #847b73 11% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-30 fusion_builder_column_1_1 1_1 fusion-flex-column"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-21 fusion_builder_column_inner_1_2 1_2 fusion-flex-column"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        alt=""
                                        className="lazyload img-responsive wp-image-6184 bv-tag-attr-replace"
                                        data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 716px"
                                        data-orig-src="/legacy-assets/uploads/2025/02/paveikslas-110.webp"
                                        data-sizes="auto"
                                        data-srcset="/legacy-assets/uploads/2025/02/paveikslas-110-200x211.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-110-400x421.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-110-600x632.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-110.webp 716w"
                                        decoding="async"
                                        height="754"
                                        src="/legacy-assets/uploads/2025/02/paveikslas-110.webp"
                                        srcSet="/legacy-assets/uploads/2025/02/paveikslas-110-200x211.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-110-400x421.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-110-600x632.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-110.webp 716w"
                                        width="716"
                                      />
                                    </span>
                                  </div>
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-22 fusion_builder_column_inner_1_2 1_2 fusion-flex-column"
                                style={{ '--awb-padding-top': '236px', '--awb-padding-right': '100px', '--awb-padding-left': '120px', '--awb-padding-top-small': '72px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-bg-size': 'cover', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '3.84%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '1', '--awb-margin-top-small': '0px', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <div
                                  className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column"
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <div
                                        className="fusion-panel panel-default panel-a0fc20495e345ae95 fusion-toggle-no-divider"
                                      ...
                                      >
                                        ...
                                        >
                                          <h4
                                            ...
                                            id="toggle_a0fc20495e345ae95"
                                          >
                                            <a
                                              aria-controls="a0fc20495e345ae95"
                                              aria-expanded="false"
                                              data-parent="#accordion-2204-8"
                                              data-target="#a0fc20495e345ae95"
                                              data-toggle="collapse"
                                              href="#a0fc20495e345ae95"
                                              role="button"
                                            >
                                              <span
                                                aria-hidden="true"
                                        ...
                                        <div
                                          aria-labelledby="toggle_a0fc20495e345ae95"
                                          className="panel-collapse collapse"
                                          id="a0fc20495e345ae95"
                                        >
                                          <div
