...
export default function Row26() {
  return (
                    <div
                      className="fusion-fullwidth fullwidth-box fusion-builder-row-26 fusion-flex-container has-pattern-background has-mask-background hundred-percent-fullwidth non-hundred-percent-height-scrolling"
                    ...
                    >
                      ...
                      >
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-37 fusion_builder_column_1_2 1_2 fusion-flex-column fusion-flex-align-self-stretch"
                        ...
                        <div
                          className="fusion-layout-column fusion_builder_column fusion-builder-column-38 fusion_builder_column_1_2 1_2 fusion-flex-column fusion-flex-align-self-stretch"
