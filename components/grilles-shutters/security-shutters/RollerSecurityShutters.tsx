export default function Row9() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '0px', '--awb-padding-bottom': '63px', '--awb-padding-left': '0px', '--awb-padding-bottom-small': '114px', '--awb-margin-bottom': '0px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 12%, #847b73 11% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        alt=""
                                        className="lazyload img-responsive wp-image-6135 bv-tag-attr-replace"
                                        data-orig-sizes="(max-width: 1024px) 100vw, (max-width: 640px) 100vw, 716px"
                                        data-orig-src="/legacy-assets/uploads/2025/02/paveikslas-104.webp"
                                        data-sizes="auto"
                                        data-srcset="/legacy-assets/uploads/2025/02/paveikslas-104-200x211.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-104-400x421.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-104-600x632.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-104.webp 716w"
                                        decoding="async"
                                        fetchPriority="high"
                                        height="754"
                                        src="/legacy-assets/uploads/2025/02/paveikslas-104.webp"
                                        srcSet="/legacy-assets/uploads/2025/02/paveikslas-104-200x211.webp 200w, /legacy-assets/uploads/2025/02/paveikslas-104-400x421.webp 400w, /legacy-assets/uploads/2025/02/paveikslas-104-600x632.webp 600w, /legacy-assets/uploads/2025/02/paveikslas-104.webp 716w"
                                        width="716"
                                      />
                                    </span>
                                  </div>
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <div
                                        className="fusion-panel panel-default panel-7656e6ae5fdc9fc81 fusion-toggle-no-divider"
                                      ...
                                      >
                                        ...
                                        >
                                          <h4
                                            ...
                                            id="toggle_7656e6ae5fdc9fc81"
                                          >
                                            <a
                                              aria-controls="7656e6ae5fdc9fc81"
                                              aria-expanded="false"
                                              data-parent="#accordion-2204-2"
                                              data-target="#7656e6ae5fdc9fc81"
                                              data-toggle="collapse"
                                              href="#7656e6ae5fdc9fc81"
                                              role="button"
                                            >
                                              <span
                                                aria-hidden="true"
                                        ...
                                        <div
                                          aria-labelledby="toggle_7656e6ae5fdc9fc81"
                                          className="panel-collapse collapse"
                                          id="7656e6ae5fdc9fc81"
                                        >
                                          <div
