                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{ '--awb-padding-top': '90px', '--awb-padding-right': '120px', '--awb-padding-bottom': '90px', '--awb-padding-left': '60px', '--awb-padding-top-small': '40px', '--awb-padding-right-small': '40px', '--awb-padding-bottom-small': '40px', '--awb-padding-left-small': '40px', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                        >
                          <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                            ...
                            >
                              <p>{` Here's why thousands across the UK trust our bespoke doors. `}</p>
                              <ul>
                                <li>{`Customised doors that meet aesthetic, functional and security expectations`}</li>
                                <li>{`Each aspect of the door reflects premium craftsmanship`}</li>
                                <li>{`Use of top-tier materials and parts for optimal durability`}</li>
                                <li>{`Quality that offers peace of mind`}</li>
                              </ul>
                            </div>
                          </div>
                        </div>
