export default function WhatIs() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '0px', '--awb-padding-right': '0px', '--awb-padding-bottom': '0px', '--awb-padding-left': '0px', '--awb-margin-bottom': '70px', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                            ...
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-1 fusion_builder_column_inner_1_2 1_2 fusion-flex-column"
                                style={{ '--awb-padding-top': '70px', '--awb-padding-right': '90px', '--awb-padding-left': '120px', '--awb-padding-top-small': '40px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-bg-size': 'cover', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '0%', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '0%', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                                  <div
                                  ...
                                  <div
                                    ...
                                    style={{ '--awb-text-color': 'var(--awb-color6)', '--awb-font-size': 'var( --awb-typography4-font-size )', '--awb-line-height': '1.5', '--awb-margin-top': '20px' } as unknown as React.CSSProperties}
                                  >
                                    <p>
                                    ...
                                    <p>{` The term 'stain glass doors' (also written as 'stained glass doors') covers a wide range of styles and techniques: `}</p>
                                    <ul>
                                      <li>{`Traditional leaded stained glass – individual pieces of coloured glass joined with lead caming, as seen in Victorian and Edwardian front doors across the UK`}</li>
                                      <li>{`Etched or sandblasted glass – designs carved or frosted into clear glass for a more subtle, contemporary effect`}</li>
                                      <li>{`Art Deco stained glass – bold geometric patterns in amber, blue and green, widely found in 1920s and 1930s properties`}</li>
                                      <li>{`Hand-painted or fired glass – entirely original designs, from family crests to abstract motifs, permanently fired into the glass surface`}</li>
                                    </ul>
                                    <p>
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-2 fusion_builder_column_inner_1_2 1_2 fusion-flex-column"
