export default function Row13() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '47px', '--awb-padding-right': '0px', '--awb-padding-bottom': '52px', '--awb-padding-left': '0px', '--awb-padding-bottom-small': '55px', '--awb-margin-top': '85px', '--awb-margin-bottom': '130px', '--awb-margin-top-small': '0px', '--awb-margin-bottom-small': '96px', '--awb-background-image': 'linear-gradient( 180deg, var(--awb-color1) 14%, #f5efe9 14% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
