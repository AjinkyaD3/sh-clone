                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      <p>
                                        {` Each of the doors offered in our range not only feature bespoke door frames but also seamless integration which does not compromise it in terms of look. Our top of the line options offer up to 115 mm of steel door frame profile with reinforced lines and locks. `}
                                      </p>
                                      <p>
                                        {` Reinforced hinges with added protection - we understand that even a seemingly small part of an internal door solution such as a door hinge has to be beefed up in order to offer the maximum amount of security. Our hinges are made from reinforced steel materials and are adjustable in height, and are easily customizable. `}
                                      </p>
                                    </div>
                                  </div>
                                </div>
