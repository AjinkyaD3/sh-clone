export default function Row17() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-right': '0px', '--awb-padding-left': '0px', '--awb-margin-bottom': '145px', '--awb-margin-bottom-small': '89px', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            data-bg-url="/legacy-assets/uploads/2025/04/Cropped_Professional_Entrance_1533x661.webp"
                            style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/04/Cropped_Professional_Entrance_1533x661.webp") !important' } as unknown as React.CSSProperties}
                          >
                            <img
