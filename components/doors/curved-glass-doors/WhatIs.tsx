                              ...
                              >
                                <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                                  ...
                                  >
                                    ...
                                    <p>
                                      {` At Secure House, every curved glass door we produce is engineered with the same security standards as our wider door range. You never have to choose between a stunning design and a door that genuinely protects your property. `}
                                    </p>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                                  <div className="fusion-image-element">
                                    <span className="fusion-imageframe imageframe-none imageframe-1 hover-type-none">
                                      <img
                                        alt="Curved glass front door UK modern glazed entrance"
