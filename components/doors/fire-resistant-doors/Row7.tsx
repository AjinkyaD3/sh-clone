export default function Row7() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-right': '0px', '--awb-padding-left': '0px', '--awb-margin-bottom': '105px', '--awb-margin-bottom-small': '0px', '--awb-flex-wrap': 'wrap' } as React.CSSProperties}
                    >
                      <div
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      {` Seamless, fire-resistant partitions of aluminum profiles with glass `}
                                    </p>
                                  </div>
                                </div>
                              </div>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      {`Fire-resistant aluminium systems`}
                                    </p>
                                  </div>
                                </div>
                              </div>
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <p>
                                      {` Most extensive and technology-advanced product `}
                                    </p>
                                  </div>
                                </div>
                              </div>
