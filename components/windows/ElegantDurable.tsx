...
export default function Row4() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '120px', '--awb-padding-right': '80px', '--awb-padding-bottom': '0px', '--awb-padding-left': '80px', '--awb-padding-top-small': '55px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-margin-top-small': '0px', '--awb-margin-top': '0px', '--awb-margin-bottom': '180px', '--awb-margin-bottom-small': '0px', '--awb-background-image': 'linear-gradient( 180deg, #f5efe9 70%, var(--awb-color1) 70% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
