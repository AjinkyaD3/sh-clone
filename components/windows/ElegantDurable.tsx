...
export default function Row4() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '120px', '--awb-padding-right': '80px', '--awb-padding-bottom': '0px', '--awb-padding-left': '80px', '--awb-padding-top-small': '90px', '--awb-padding-right-small': '40px', '--awb-padding-left-small': '40px', '--awb-margin-top': '0px', '--awb-margin-bottom': '180px', '--awb-margin-bottom-small': '0px', '--awb-background-image': 'linear-gradient( 180deg, #f5efe9 70%, var(--awb-color1) 70% )', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <p>
                                {` Our windows combine style with practicality. With a diverse selection`}
                                <br />
                                {` available, we have options to complement any home, setting, and budget. `}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-3 fusion_builder_column_inner_1_2 1_2 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <Link
                                    ...
                                    href="/windows/high-security-steel-windows/"
                                  >
                                    <span
                              ...
                              <div
                                className="fusion-layout-column fusion_builder_column_inner fusion-builder-nested-column-4 fusion_builder_column_inner_1_2 1_2 fusion-flex-column fusion-flex-align-self-center fusion-column-inner-bg-wrapper fusion-column-liftup-border"
                                data-scroll-devices="small-visibility,medium-visibility,large-visibility"
                                style={{ '--awb-padding-top': '370px', '--awb-inner-bg-image': 'linear-gradient( 0deg, rgba(255, 255, 255, 0.8) 17%, rgba(255, 255, 255, 0) 0% )', '--awb-inner-bg-size': 'cover', '--awb-border-color': 'var(--awb-color6)', '--awb-inner-border-color': 'var(--awb-color6)', '--awb-border-style': 'solid', '--awb-inner-border-style': 'solid', '--awb-width-large': '50%', '--awb-margin-top-large': '0px', '--awb-spacing-right-large': '10px', '--awb-margin-bottom-large': '0px', '--awb-spacing-left-large': '10px', '--awb-width-medium': '100%', '--awb-order-medium': '0', '--awb-spacing-right-medium': '1.92%', '--awb-spacing-left-medium': '1.92%', '--awb-width-small': '100%', '--awb-order-small': '0', '--awb-spacing-right-small': '1.92%', '--awb-margin-bottom-small': '40px', '--awb-spacing-left-small': '1.92%' } as unknown as React.CSSProperties}
                              >
                                <span
                                ...
                                >
                                  <Link
                                    className="fusion-column-anchor"
                                    href="/windows/security-aluminium-windows/"
                                  >
                                    <span
                                      className="fusion-column-inner-bg-image lazyload"
                                      data-bg-gradient="linear-gradient(0deg, rgba(255,255,255,0.8) 17%,rgba(255,255,255,0) 0%)"
