export default function Row18() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-right': '0px', '--awb-padding-left': '0px', '--awb-margin-bottom': '0px', '--awb-margin-top': '130px', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            data-bg-url="/legacy-assets/uploads/2025/02/Mask-group-16.webp"
                            style={{ backgroundImage: 'url("/legacy-assets/uploads/2025/02/Mask-group-16.webp") !important' } as unknown as React.CSSProperties}
                          >
                            <img
