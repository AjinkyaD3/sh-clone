export default function Row8() {
  return (
                    <div
                      ...
                      style={{ '--awb-border-radius-top-left': '0px', '--awb-border-radius-top-right': '0px', '--awb-border-radius-bottom-right': '0px', '--awb-border-radius-bottom-left': '0px', '--awb-padding-top': '174px', '--awb-padding-right': '0px', '--awb-padding-left': '0px', '--awb-padding-top-small': '75px', '--awb-margin-top-small': '0px', '--awb-margin-top': '0px', '--awb-background-color': 'var(--awb-color1)', '--awb-flex-wrap': 'wrap' } as unknown as React.CSSProperties}
                    >
                      <div
